package org.wwlib.starling 
{
	...
	public class WwMainMenuScene extends WwScene
	{
		...
		private function startAnimation():void
		{
			...
			__buttonVector.push(newButtonWrapper("btn_aquarium", buttonHandler));
			__buttonVector.push(newButtonWrapper("btn_share", buttonHandler));
			__buttonVector.push(newButtonWrapper("btn_wwlib", buttonHandler));
			
			var fish_mc:MovieClip = __UI_MainMenu["btn_aquarium"]["fish"];
			fish_mc.mouseEnabled = false;
			fish_mc.mouseChildren = false;
			...
			if (event.type == MouseEvent.MOUSE_UP)
			{
				switch (target.name) 
				{
					case "btn_wwlib":
						...
						break;
					case "btn_aquarium":
						__sceneManager.gotoScene("Aquarium");
						break;
					case "btn_share":
