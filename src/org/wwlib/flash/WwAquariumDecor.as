package org.wwlib.flash
{
	...
	public class WwAquariumDecor
	{
		...
		private var __controller:WwAquariumDecorController;
		...
		public function WwAquariumDecor(_controller, _mc:MovieClip, _object_plane:MovieClip, _frame_rate:Number=12.0)
		{
			...
			//state = STATE_FAST;
			__velocityVector = new Point(0, 0);
			__velocityMagnitude = new Point(0,0);
			__friciton = .01;
		...
		public function get controller():WwAquariumDecorController
		{
			return __controller;
		}
